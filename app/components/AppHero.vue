  ...
  <section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-brand-50 pt-16">
    ...
    <div class="relative max-w-5xl mx-auto px-6 py-24">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
        ...
        <a
          href="#proyectos"
          class="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 rounded-xl border border-slate-300 hover:border-slate-400 text-slate-600 hover:text-slate-900 font-semibold text-lg transition-colors duration-200"
        >
          Ver proyectos
        </a>
      </div>
